                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="d-flex bd-highlight">
                                    <div class="p-2 bd-highlight">
                                        <div class="btn-toolbar mb-3" role="toolbar"
                                            ...
                                            <div class="input-group me-2">
                                                <button type="button" @click="docx.StartServices(this.quantity_services)" class="btn btn-success"
                                                    title="Запускает указанное число микро сервисов"><font-awesome-icon
                                                        icon="fa-solid fa-play" /></button>
                                                <input type="number" @change="this.quantity_services = $event.target.value" class="form-control" value="1" min="1" step="1"
                                    ...
                                    <div class="p-2 bd-highlight">
                                        <button type="button" @click="docx.Info()" class="btn btn-primary"><font-awesome-icon
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr v-for="(item) in docx.Data" :key="item.Pid">
                                        <th>
                                            <div class="form-check">
                                                <input class="form-check-input" @change="docx.SelectRow($event, item.Pid)" :checked="item.select" type="checkbox" value=""
                                                    id="flexCheckDefault">
                                            </div>
                                        </th>
                                        <td>{{ item.index }}</td>
